...
def run():
    ...
    plotting.plot_lane_metrics(data.steps, data.wait, data.phases, "Turn vs. Straight: Wait Time", "Seconds", [0], [2])
    plotting.plot_lane_metrics(data.steps, data.speed, data.phases, "Turn vs. Straight: Speed", "m/s", [0], [2])
    plotting.plot_lane_metrics(data.steps, data.queue, data.phases, "Turn vs. Straight: Queue", "Vehicles", [0], [2])
    plotting.show_plots()
