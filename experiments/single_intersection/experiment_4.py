...
def _setup_perpendicular_flows(num_vehicles=20):
    """Spawn equal vehicles from North→South and East→West."""
...
def run():
    _setup_perpendicular_flows(num_vehicles=20)
    ...
    plotting.plot_lane_metrics(
        ...
        data.wait,
        data.phases,
        "Avg Wait Time: Perpendicular Conflict",
        "Seconds",
        [0],
        [2],
    )
